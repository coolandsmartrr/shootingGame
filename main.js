...
var imageRepository = new function() {
  ...
  this.enemyBullet.src = "imgs/enemyBullet.png";
}
...
// Create the Background object which will become a child of
...
function Background() {
  ...
  this.draw = function() {
    ...
    this.context.drawImage(imageRepository.background,
                            this.x, this.y - this.canvasHeight);
...
function Bullet(object) {
  ...
  // Return true if the bullet moved off the screen, indicating that
...
function QuadTree(boundBox, lvl) {
  ...
  // Return all objects that the objects could collide with
  ...
  // If the tree excedes the capacity, it will split and
  ...
  this.insert = function(obj) {
    ...
    if (this.nodes.length) {
      var index = this.getIndex(obj);
      // Only add the object to a subnode
      // if it can fit completely within one
      if (index != -1) {
  ...
  // -1 means object cannot completely fit within a node
...
// Custom Pool object. Holds Bullet objects to be amangaed to prevent
// garbage collection.
...
function Game() {
  // Gets canvas informationa and context and sets up all game
  // objects.
...
// optimize the game leep and draws all game objects.
// This function must be a global function and cannot be written
// within an object.
...
// it sts the appropriate direction to true to let us know which
// key it was.
